...
[**Download the latest release (`paintdotnet-ico.zip`)**](https://github.com/enclaro/twojstar/releases/latest/download/paintdotnet-ico.zip)

The ZIP contains separate folders for Paint.NET 5.2+ and Paint.NET 5.1.x plus `Install.bat`. It is published in the shared `enclaro/twojstar` rolling Latest release, so the download URL stays stable without a plugin-specific release tag.
