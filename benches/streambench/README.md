...
This project lives in the `enclaro/twojstar` workshop under `benches/streambench/`.

1. In Cloudflare Workers & Pages create a Worker by importing `enclaro/twojstar`.
