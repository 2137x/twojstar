...
This project lives in the `travnie/twojstar` workshop under `benches/streambench/`.

1. In Cloudflare Workers & Pages create a Worker by importing `travnie/twojstar`.
